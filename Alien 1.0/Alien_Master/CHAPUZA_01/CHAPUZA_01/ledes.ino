...
void muestra_suelo (void)
{
  leds.clear();
  if (caso_suelo == 1)
  {
    leds.setPixelColor(15, leds.Color(0, 60, 0)); // verde, poco brillante
    leds.setPixelColor(0, leds.Color(0, 60, 0)); // verde, poco brillante
    leds.setPixelColor(1, leds.Color(0, 60, 0)); // verde, poco brillante
  }
  else
  ...
  {
    leds.setPixelColor(3, leds.Color(0, 60, 0)); // verde, poco brillante
    leds.setPixelColor(4, leds.Color(0, 60, 0)); // verde, poco brillante
    leds.setPixelColor(5, leds.Color(0, 60, 0)); // verde, poco brillante
  }
  else
  {
  ...
  if (caso_suelo == 3)
  {
    leds.setPixelColor(7, leds.Color(0, 60, 0)); // verde, poco brillante
    leds.setPixelColor(8, leds.Color(0, 60, 0)); // verde, poco brillante
    leds.setPixelColor(9, leds.Color(0, 60, 0)); // verde, poco brillante
  }
  else
  {
  ...
  if (caso_suelo == 4)
  {
    leds.setPixelColor(11, leds.Color(0, 60, 0)); // verde, poco brillante
    leds.setPixelColor(12, leds.Color(0, 60, 0)); // verde, poco brillante
    leds.setPixelColor(13, leds.Color(0, 60, 0)); // verde, poco brillante
  }
  else
  {
